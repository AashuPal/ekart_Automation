...
/**
 * STEP 11: Automate Login (Valid Credentials)
 * STEP 12: Automate Login (Invalid Credentials)
...
public class LoginTest extends BaseTest {
    ...
    public void testLoginPageHeading() {
        ...
        Assert.assertTrue(heading.toLowerCase().contains("login")
                || heading.toLowerCase().contains("sign in")
                || heading.length() > 0,
