...
public class WaitUtils {
    ...
    /**
     * Wait until element is INVISIBLE (disappears from DOM/view)
     * Use this for loading spinners, overlays etc.
     */
    ...
    /**
     * Safe version of waitForInvisible — uses short timeout (5s)
     * Does NOT throw exception if element is never found (already invisible = OK)
     * Use this for optional spinners that may or may not appear
     */
